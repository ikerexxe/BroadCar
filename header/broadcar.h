...
#endif
/*
 * Definici�n del numero maximo de caracteres por linea
 */
...
unsigned long g_ul_keypad_switches; /*Valor le�do en los botones*/
unsigned char g_uc_changed_data; /*Si ha cambiado la tecla que se est� pulsando*/
/*****************************************************************************
** 																			**
** EOF 																		**
** 																			**
